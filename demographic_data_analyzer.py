...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich =(df[(df["education"].isin(["Bachelors","Masters","Doctorate"])) & (df["salary"] == ">50k")]["education"].count())/higher_education *100
    lower_education_rich = (df[(~df["education"].isin(["Bachelors","Masters","Doctorate"])) & (df["salary"] == ">50k")]["education"].count())/lower_education *100
